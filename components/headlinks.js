class HeadLinks extends HTMLElement {
  ...
  connectedCallback() {
    this.innerHTML = `
      ...
      <link href="https://fonts.googleapis.com/css2?family=Antonio:wght@100..700&family=Big+Shoulders:opsz,wght@10..72,100..900&family=Boldonse&display=swap" rel="stylesheet">
