class HeadLinks extends HTMLElement {
  ...
  connectedCallback() {
    this.innerHTML = `
      ...
      <link href="https://fonts.googleapis.com/css2?family=Anton&family=Boldonse&family=Geostar+Fill&family=Libre+Barcode+39+Text&family=Press+Start+2P&family=Redacted+Script:wght@300;400;700&family=Russo+One&family=Tektur:wght@400..900&display=swap" rel="stylesheet">
      <!-- end replace -->
    `;
  }
  constructor() {
